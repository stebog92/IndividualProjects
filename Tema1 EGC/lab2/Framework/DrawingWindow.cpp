...
DrawingWindow::DrawingWindow(int argc, char** argv,int _width, int _height, int startX, int startY, string name)
{
	...
	glutKeyboardFunc(keyPressed); //functia apelata la apasarea unei taste
	glutKeyboardUpFunc(keyUp);

	glutSpecialFunc(keySpecial); //functia apelata la apasarea unei taste speciale
...
void DrawingWindow::keyPressed (unsigned char key, int x, int y) {
	onKey(key);
}

void DrawingWindow::keyUp (unsigned char key, int x, int y) {
	onKeyUp(key);
}

void DrawingWindow::keySpecial (int key, int x, int y) {
	onSpecialKey(key);
}

void DrawingWindow::keySpecialUp (int key, int x, int y) {
	onSpecialKeyUp(key);
}
